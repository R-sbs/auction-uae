      ...
      <div className="mx-auto grid max-w-7xl grid-cols-1 lg:grid-cols-2">
        <div className="relative px-6 pb-20 pt-24 sm:pt-32 lg:static lg:px-8 lg:py-20">
          <div className="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
            ...
            <h2 className="text-h3 font-serif font-bold tracking-wide text-gray-900">
              Get in touch
            </h2>
            <p className="mt-6 text-base-lg leading-8 text-gray-600">
              We&apos;d love to assist you. Whether you have questions about our
              auctions, need help with bidding, or have any other inquiries, our
